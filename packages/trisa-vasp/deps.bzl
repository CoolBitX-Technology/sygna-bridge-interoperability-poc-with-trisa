...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_coolbitx_technology_sygna_bridge_util_go",
        importpath = "github.com/CoolBitX-Technology/sygna-bridge-util-go",
        sum = "h1:cqrrSz33Z6jtf6vwgKm9zAjqq77RDRGL7f4pSGX1HTU=",
        version = "v0.0.0-20200826022805-6b0af5cad984",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_fomichev_secp256k1",
        importpath = "github.com/fomichev/secp256k1",
        sum = "h1:YbIfHI+s+tauzUAdNw+lF8a9o056PoIPaLGodgh5D7g=",
        version = "v0.0.0-20180413221153-00116ff8c62f",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:3EioagmlSG+z+KySToa+Ylo3pTFZs+jh3Brl7ngU12U=",
        version = "v0.3.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:xGHheKK44eC6K0u5X+DZW/fRaR1LnDdqPHMZMWx5fv8=",
        version = "v0.0.0-20190916142128-fa8279994f75",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:ly4zBm6mBhzzUaA9egkKIgpCBuSEVdlSHsk40kLeCno=",
        version = "v0.0.0-20200721034629-82ea6953710d",
    )
    go_repository(
        name = "com_github_coolbitx_technology_sygna_bridge_ivms_utils_golang",
        importpath = "github.com/CoolBitX-Technology/sygna-bridge-ivms-utils/golang",
        sum = "h1:eCiXdkacKYgXHVEC9YeUIacF2O/ZGWJUjcMHaS1Tnv4=",
        version = "v0.0.0-20200902024743-d9e26cce08be",
    )
